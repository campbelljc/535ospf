...
#define MAC_STUB1_ADDR              {0x33, 0x33, 0x00, 0x00, 0x00, 0x16}
#define MAC_STUB2_ADDR              {0x33, 0x33, 0xFF, 0x00, 0x00, 0x01}
#define MAC_STUB3_ADDR              {0x33, 0x33, 0x00, 0x00, 0x00, 0x02}
#define MAC_STUB4_ADDR              {0x33, 0x33, 0xFF, 0x00, 0x00, 0x02}
#define MAC_STUB4_ADDR              {0x33, 0x33, 0xFF, 0x00, 0x00, 0x03}

#define IP_BCAST_ADDR               {0xFF, 0xFF, 0xFF, 0xFF}
#define IP_BCAST_ADDR2              {0x00, 0xFF, 0xFF, 0xFF}
